...
GO
-- Add other attributes to the Fact_Operations table
...
ALTER TABLE Op.Fact_Operations ADD Duration_Of_Operation DECIMAL(5, 2); -- Duration of Operation
...
GO
-- Add other attributes to the DimOP table
